...
"""autogenerated by genpy from cm_listener/msg_cm.msg. Do not edit."""
import codecs
import sys
...
class msg_cm(genpy.Message):
  _md5sum = "51e1ed7c5e784b847030fbe04b6e407c"
  _type = "cm_listener/msg_cm"
...
string frame_id
"""
  __slots__ = ['header','name','position','temperature','voltage']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,position,temperature,voltage
    ...
    """
    if args or kwds:
      super(msg_cm, self).__init__(*args, **kwds)
