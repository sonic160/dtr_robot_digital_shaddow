...
if __name__ == '__main__':
    ...
    trajectories = [[500, 482, 247, 624, 353, 100], 
    ...
    # Define failures.
    failed_trajectories = [] # The second and sixth row in trajectories.
    failed_motors = [] # For the first row, motor 1 and 5 fail. For the sixth, motor 6 fails.
