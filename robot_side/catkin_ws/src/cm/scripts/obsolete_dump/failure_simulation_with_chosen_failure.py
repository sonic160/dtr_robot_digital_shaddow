...
if __name__ == '__main__':
    ...
    trajectories,durations_lists = generate_and_get_matrices(5,1000,0)
 ...
 """   
    ...
    #failed_trajectories = sorted(random.sample(range(5),3))
    failed_trajectories = [2,3,4,5]
    if failure_type ==0:
        failed_trajectories = [1,2,3,4,5]
